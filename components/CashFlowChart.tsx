...
export const CashFlowChart: React.FC<CashFlowChartProps> = ({ workflows, scenarioWorkflows, onClearScenario }) => {
  ...
  return (
    <div className="bg-secondary/50 rounded-lg shadow-lg p-4 md:p-6 border">
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-lg font-semibold text-foreground">90-Day Cash Flow Forecast</h3>
       ...
       {scenarioWorkflows && (
          <div className="bg-purple-900/50 border border-purple-700 rounded-lg p-3 flex justify-between items-center mb-4 text-sm">
              ...
              <Button 
                ...
                variant="ghost"
                size="sm"
                className="flex items-center gap-1 text-xs font-semibold text-purple-200 hover:text-white bg-purple-800/50 hover:bg-purple-700 h-auto px-2 py-1"
              >
      ...
      <div className="flex justify-between items-end h-48 space-x-4">
        {baseForecast.map((data, index) => (
          <div key={index} className="flex flex-col items-center flex-1 h-full justify-end">
             <div className="flex items-center gap-1 text-sm font-bold text-foreground mb-1">
            ...
            <div className="w-full flex items-end gap-1 h-full">
              <div
                className="w-full bg-primary/80 rounded-t-md hover:bg-primary/70 transition-all"
