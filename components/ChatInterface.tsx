               ...
               {msg.role === 'model' && msg.content && !msg.isThinking && (
                 <div className="mt-1 text-right">
                    <button 
                        ...
                        className="flex items-center gap-1 text-xs text-muted-foreground hover:text-foreground disabled:text-muted-foreground/50 disabled:cursor-not-allowed transition-colors h-auto p-0"
                    >
        ...
        <div className="flex items-center gap-2">
          <div className="relative" ref={toneMenuRef}>
            <button
              ...
              className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 bg-secondary text-secondary-foreground hover:bg-secondary/80 h-9 px-3 gap-1.5 text-xs"
            >
              <span>Tone: {tone}</span>
              <ChevronDownIcon className="w-3 h-3"/>
            </button>
            {isToneMenuOpen && (
              <div className="absolute bottom-full mb-2 w-32 rounded-md shadow-lg bg-popover ring-1 ring-black ring-opacity-5 z-10 border">
                <div className="py-1">
                  {tones.map(t => (
                    <a
                      href="#"
          ...
          <button
            ...
            className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 disabled:bg-muted flex-shrink-0 h-10 w-10"
          >
